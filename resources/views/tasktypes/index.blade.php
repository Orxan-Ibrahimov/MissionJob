    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex justify-content-between m-2">
                <h2 class="card-title mb-0">Tapsırıq növü</h2>
            ...
            <table class="table table-hover table-striped table-dark">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="/tasktypes/{{$tasktype -> id}}/edit" class="btn btn-outline-warning m-2"><i class="mdi mdi-table-edit"></i></a>
                            <button form="{{$tasktype->id}}_delete" class="btn btn-outline-danger m-2"><i class="mdi mdi-delete-variant"></i></button>
