...
<body>
    <div class="container-scroller">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
                <a class="sidebar-brand brand-logo" href="index.html"><img src="{{ URL::asset('layouts/manager/images/logo.svg') }}" alt="logo" /></a>
                <a class="sidebar-brand brand-logo-mini" href="index.html"><img src="{{ URL::asset('layouts/manager/images/logo-mini.svg') }}" alt="logo" /></a>
            </div>
            <ul class="nav">
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="navbar p-0 fixed-top d-flex flex-row">
                <div class="navbar-brand-wrapper d-flex d-lg-none align-items-center justify-content-center">
                    <a class="navbar-brand brand-logo-mini" href="index.html"><img src="{{ URL::asset('layouts/manager/images/logo-mini.svg') }}" alt="logo" /></a>
                </div>
                    ...
                    <ul class="navbar-nav navbar-nav-right">
                        ...
                        <li class="nav-item dropdown border-left">
                            ...
                            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="messageDropdown">
                                ...
                                <a class="dropdown-item preview-item">
                                    <div class="preview-thumbnail">
                                        <img src="{{ URL::asset('layouts/manager/images/faces/face4.jpg') }}" alt="image" class="rounded-circle profile-pic">
                                    </div>
                                    <div class="preview-item-content">
                                ...
                                <a class="dropdown-item preview-item">
                                    <div class="preview-thumbnail">
                                        <img src="{{ URL::asset('layouts/manager/images/faces/face2.jpg') }}" alt="image" class="rounded-circle profile-pic">
                                    </div>
                                    <div class="preview-item-content">
                                ...
                                <a class="dropdown-item preview-item">
                                    <div class="preview-thumbnail">
                                        <img src="{{ URL::asset('layouts/manager/images/faces/face3.jpg') }}" alt="image" class="rounded-circle profile-pic">
                                    </div>
                                    <div class="preview-item-content">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown">
                                <div class="navbar-profile">
                                    <p class="mb-0 d-none d-sm-block navbar-profile-name">{{Auth::user() -> active_role}}</p>
                                    <i class="mdi mdi-menu-down d-none d-sm-block"></i>
                                </div>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="profileDropdown">
                                ...
                                <a class="dropdown-item preview-item">
                                    ...
                                    <form method="post" action="/switch_role" class="preview-item-content">
                                        @csrf
                                        @method('PATCH')
                                        <input type="text" name="role" value="{{ $role -> name }}" hidden>
                                        <button type="submit" class="preview-subject mb-1">{{ $role -> name }}</button>
                                    </form>
                                </a>
                                <div class="dropdown-divider"></div>
                                @endif
    ...
    <script src="{{ URL::asset('layouts/manager/vendors/chart.js/Chart.min.js') }}"></script>
    <script src="{{ URL::asset('layouts/manager/vendors/progressbar.js/progressbar.min.js') }}"></script>
    <script src="{{ URL::asset('layouts/manager/vendors/jvectormap/jquery-jvectormap.min.js') }}"></script>
    <script src="{{ URL::asset('layouts/manager/vendors/jvectormap/jquery-jvectormap-world-mill-en.js') }}"></script>
